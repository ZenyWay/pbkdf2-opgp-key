# Contributing to pbkdf2-opgp-key
...
[pbkdf2-opgp-key Gitter channel](https://gitter.im/ZenyWay/pbkdf2-opgp-key).

## <a name="issues"></a> Issues
### Security issues
For the security of the community relying on pbkdf2-opgp-key,
...
are tracked as GitHub [issues in this repository](https://github.com/ZenyWay/pbkdf2-opgp-key/issues):
* please either [submit a new issue](https://github.com/ZenyWay/pbkdf2-opgp-key/issues/new)
...
**pbkdf2-opgp-key version:** (only for issues) first version of pbkdf2-opgp-key affected by the issue
...
* a PR must close at least one [open issue](https://github.com/ZenyWay/pbkdf2-opgp-keyg/issues?utf8=%E2%9C%93&q=is%3Aissue+is%3Aopen).
The corresponding issues should be listed in the title of the PR,
e.g. "close #21, #42".
* all PRs must pass the full pbkdf2-opgp-key test suite and
...
https://github.com/ZenyWay/pbkdf2-opgp-key/blob/master/ICLA.
```
This is required both in the contributor's own interest,
and that of the community relying on this project,
...
#### CI
CI testing runs on [TravisCI](https://travis-ci.org/ZenyWay/pbkdf2-opgp-key).
